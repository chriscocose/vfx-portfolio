...
export const projects: Project[] = [
  ...
  },
  {
    id: "miami",
    slug: "miami-case",
    title: "Miami Dolphins - UI/UX Case Study",
    year: 2025,
    roles: ["Design", "VFX", "UI/UX"],
    tags: ["UI/UX"],
    summary:
      "I designed a motion-driven player-page concept for the Miami Dolphins that merges broadcast-level visual storytelling with user-centric interaction design. Using After Effects, I utilized VFX and kinetic typography inspired by team broadcast packages — blending color, motion rhythm, and type hierarchy to capture the brand’s athletic energy. I then brought those visuals into Figma, translating the motion language into a responsive UI/UX system featuring the animations and a streamlined web/mobile layout. The result is a cohesive fan experience where motion enhances usability — not just aesthetics — and every transition reflects the team’s speed and personality. This project bridges my background in VFX, typography, and front-end design, demonstrating how cinematic motion principles can elevate interactive design and storytelling in digital sports experiences. Here is a link to the case study: https://www.figma.com/proto/8CSnt28vrtgRIlJL8LWLbu/Miami-Dolphins---Player-Redesign?node-id=2-2378&p=f&t=VCMSe6v5c4AmTswv-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=2%3A2378 ",
    cover: "/covers/miami.jpg",
    mediaType: "image",
  ...
  },
  {
    ...
    year: 2023,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Music Videos"],
    summary:
      "BabyTron - Down, Up! (Official Video)",
    cover: "/covers/babytron.jpg",
    mediaType: "image",
    mediaSrc: "/videos/downup.mp4",
  },
  {
    id: "gun",
    slug: "gun-visualizer",
    title: "Cooking Soul & Westside Gunn - THE GUNN TAPE (Visualizer)",
    year: 2024,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Visualizers"],
    summary:
      "",
    cover: "/covers/gun.jpg",
    mediaType: "image",
    mediaSrc: "/videos/gun.mp4",
  },
  {
    id: "trippie",
    slug: "trippie-video",
    title: "Trippie Redd - LIFE'S A TRIP (Visualizer)",
    year: 2024,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Visualizers"],
    summary:
      "",
    cover: "/covers/trippie.jpg",
    mediaType: "image",
    mediaSrc: "/videos/trippie.mp4",
  },
  {
    id: "kodak",
    slug: "kodak-visualizer",
    title: "Kodak Black - Heart Break Kodak (HBK) (Visualizer)",
    year: 2024,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Visualizers"],
    summary:
    ...
    mediaType: "image",
    mediaSrc: "/videos/kodak.mp4",
  },
  {
    id: "nopain",
    slug: "nopain-visualizer",
    title: "GRiZ - Feel No Pain (Visualizer)",
    year: 2024,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Visualizers"],
    summary:
      "",
    cover: "/covers/nopain.jpg",
    mediaType: "image",
    mediaSrc: "/videos/nopain.mp4",
  },

  {
    id: "cats",
    slug: "cats-video",
    title: "Pouya - THE CATS CRYING OUTSIDE MY WINDOW SOUND LIKE THE END OF THE WORLD (Official Music Video)",
    year: 2025,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Music Videos"],
    summary:
      "Pouya - THE CATS CRYING OUTSIDE MY WINDOW SOUND LIKE THE END OF THE WORLD (Official Music Video)",
    cover: "/covers/cats.jpg",
    mediaType: "image",
    mediaSrc: "/videos/cats.mp4",
  },
  
  {
    id: "tank",
    slug: "tank-video",
    title: "Pouya - TANK GIRL (Official Video)",
    year: 2025,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Music Videos"],
    summary:
      "Pouya - TANK GIRL (Official Video)",
    cover: "/covers/tank.jpg",
    mediaType: "image",
    mediaSrc: "/videos/tank.mp4",
  },

  {
    id: "paid",
    slug: "paid-video",
    title: "Pouya - PAID MY DUES (Official Music Video)",
    year: 2025,
    roles: ["Design", "VFX", "Editor"],
    tags: ["Music Videos"],
    summary:
      "Pouya - PAID MY DUES (Official Music Video)",
    cover: "/covers/paid.jpg",
    mediaType: "image",
